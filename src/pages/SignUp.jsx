  ...
  return (
    <div className="signup-div">
      ...
      <form className="loginForm">
        <h1 className="SignInHeading">Create Account</h1>
        ...
        <div className="inputField">
          ...
          <div className="passwordField-eyeIcon">
            <input
          ...
          <div className="passwordField-eyeIcon">
            ...
            <span onClick={()=>{
              ...
              {confirmpassword ? (
                <IoMdEye className="eye1" />
              ) : (
                <IoEyeOff className="eye1" />
              )}
            </span>
          </div>
          ...
          <div className="rememberMe-ForgotPassword">
            <div className="rememberMe">
              ...
              />
              <label htmlFor="checkbox-input">Remeber Me</label>
            </div>
