  ...
  return (
    <div className="signup-div">
      ...
      <form className="loginForm">
        ...
        <input type="email" className="email-input" required placeholder="Email"/>
        
        <input type={`${formData.password ? "text" : "password"}`} className="password-inputFieldForSigninpage" required placeholder="Password"/>

        <input type={`${formData.password ? "text" : "password"}`} className="password-inputFieldForSigninpage" required placeholder="Confirm Password"/>
        
        <div className="rememberMe-ForgotPassword">
          <label className="showPassword">
            <input type="checkbox" className="showPassword-checkbox" name="password" checked={formData.password} onChange={handleCheckboxChange}/>
            <p className="showPassword-paragraph">Show Password</p>
          </label>

          <Link className="forgotPassword">Forgot Password?</Link>
        </div>

        <button className="SignInPage-loginBtn">Create Account</button>
      </form>
