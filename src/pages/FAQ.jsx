    ...
    <div className="faq-container">
      <div className="track-of-path">
        <div className="track">
          ...
          <p className="signup">Faqs</p>
        </div>
      </div>

      <div className="faq">
        <div className="faq-description">
          <h1>Welcome, Let’s Talk About Our Ecobazar</h1>
          <ul>
            <li>
              <div className="plusIconAndDesc">
              ...
              <div className={`${faq1 ? "faq-true-style" : "faq-false-style"}`}>
            ...
            <li>
              ...
              <div className={`${faq2 ? "faq-true-style" : "faq-false-style"}`}>
                Morbi porttitor ligula in nunc varius sagittis. Proin dui nisi,
                laoreet ut tempor ac, cursus vitae eros. Cras quis ultricies
                elit. Proin ac lectus arcu. Maecenas aliquet vel tellus at
                accumsan. Donec a eros non massa vulputate ornare. Vivamus
            ...
            <li>
              ...
              <div className={`${faq3 ? "faq-true-style" : "faq-false-style"}`}>
                Morbi porttitor ligula in nunc varius sagittis. Proin dui nisi,
                laoreet ut tempor ac, cursus vitae eros. Cras quis ultricies
                elit. Proin ac lectus arcu. Maecenas aliquet vel tellus at
                accumsan. Donec a eros non massa vulputate ornare. Vivamus
        ...
        <div className="old-geezer-image"></div>
      </div>
