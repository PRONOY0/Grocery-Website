  ...
  return (
    <div className="checkout-container">
      <div className="bottom-navbar-mobile">
        <NavLink
          to="/shop"
          className={`${whichNavClicked === 1 ? "navClickedActive" : ""}`}
        ...
        <NavLink
          to="/recipe"
          className={`${whichNavClicked === 2 ? "navClickedActive" : ""}`}
        ...
        <NavLink
          to="/"
          className={`${whichNavClicked === 3 ? "navClickedActive" : ""}`}
          onClick={() => navClickHandler(3)}
        >
        ...
        <NavLink
          to="/contact"
          className={`${whichNavClicked === 4 ? "navClickedActive" : ""}`}
          onClick={() => navClickHandler(4)}
        >
        ...
        <NavLink
          to="/signin"
          className={`${whichNavClicked === 5 ? "navClickedActive" : ""}`}
          onClick={() => navClickHandler(5)}
        >
      ...
      <form className="checkout-form">
        <div className="billing-left-section">
          ...
          <div className="firstname-lastname-companyName">
            <label className="billing-label-firstname">
              <p className="billing-label-text">First name</p>
              <input
                type="text"
            ...
            <label className="billing-label-lastname">
              <p className="billing-label-text">Last name</p>
              <input
                type="text"
            ...
            <label className="billing-label-companyname">
              <p className="billing-label-text">Company Name (optional)</p>
              <input
                type="text"
          ...
          <div className="state-zipCodes">
            <label className="state">
              ...
              <select name="states" id="stateName" required>
            ...
            <label className="zipCode">
              <p className="zip-code">Zip Code</p>
              <input
                type="tel"
          ...
          <div className="email-and-phoneNumber">
            <label className="emailandinput">
              <p className="emailandphonetext">Email</p>
              <input
                type="email"
            ...
            <label className="phonenumberandinput">
              <p className="emailandphonetext">Phone Number</p>
              <input
                type="phone-number"
          ...
          <label className="defaultaddresscheckbox">
            <input type="checkbox" />
            <p className="default-text">Set it as default address</p>
          </label>
          ...
          <div className="additional-info">
            ...
            <label className="order-notes">
              ...
              <textarea
                className="textarea-of-checkout"
          ...
          <div className="table-for-purchased">
            ...
            <div className="payment-method">
              ...
              <label className="label-text">
                ...
                <p className="paymentDelivery">Amazon Pay</p>
              </label>
              ...
              <label className="label-text">
                <input type="radio" name="radio-btns" />
                <p className="paymentDelivery">Cash on Delivery</p>
              </label>

              <button id="place-orderBUTTON" onClick={placeOrderHandler}>
                Place Order
              </button>
            </div>
          </div>
