...
const RecipeSearch = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setCount(data.count);
      setRecipes(data.hits); // Assuming the API response has a 'hits' property containing the recipes
    } catch (error) {
              ...
              <ul className="diet-filter">
                <li>
                  <input
                    ...
                    name="dietType"
                    id="balanced"
                    onChange={() => setSelectedDiet("balanced")}
                    checked={selectedDiet === "balanced"}
                  />
                  <label htmlFor="balanced">Balanced</label>
                </li>
