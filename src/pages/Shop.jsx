...
const Shop = () => {
  ...
  const totalFreshfruit = freshFruit.length;

  const Freshvegetables = data.filter(
    (item) => item.category === "Freshvegetables"
  );
  const totalFreshVegetables = Freshvegetables.length;

  const meat = data.filter((item) => item.category === "Meat");
  const totalMeat = meat.length;

  const snacks = data.filter((item) => item.category === "Snacks");
  const totalSnacks = snacks.length;

  const Beverages = data.filter((item) => item.category === "Beverages");
  const totalBeverages = Beverages.length;

  const BreadBakery = data.filter((item) => item.category === "BreadBakery");
  const totalBreadBakery = BreadBakery.length;

  const Cooking = data.filter((item) => item.category === "Cooking");
  const totalCooking = Cooking.length;

  const Dishdetergent = data.filter(
    (item) => item.category === "Dishdetergent"
  );
  const totalDishDetergent = Dishdetergent.length;

  const DiabeticFood = data.filter((item) => item.category === "DiabeticFood");
  const totalDiabeticFood = DiabeticFood.length;

  const BakingNeeds = data.filter((item) => item.category === "BakingNeeds");
  const totalBakingNeeds = BakingNeeds.length;

  const allProudcts = data.filter(
    (item) =>
    ...
    <div className="shop-container">
      ...
      <div className="filter-product-section">
              ...
              <li>
                <label>
                  <input
                    ...
                    onChange={() => {
                      setUserFilteredCategory("FreshFruit");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "FreshFruit"}
                  />
                  <span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("Freshvegetables");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "Freshvegetables"}
                  />
                  <span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("Cooking");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "Cooking"}
                  />
                  <span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("Snacks");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "Snacks"}
                  />
                  <span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("Beverages");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "Beverages"}
                  />
                  <span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("Meat");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "Meat"}
                  />
                  <span>
                    Meat<p>{`(${totalMeat})`}</p>
                  </span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("Dishdetergent");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "Dishdetergent"}
                  />
                  <span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("BreadBakery");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "BreadBakery"}
                  />
                  <span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("BakingNeeds");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "BakingNeeds"}
                  />
                  <span>
              ...
              <li>
                <label>
                  <input
                    ...
                    name="productTypeFilter"
                    onChange={() => {
                      setUserFilteredCategory("DiabeticFood");
                      setAllSelected(false);
                    }}
                    checked={userFilteredCategory === "DiabeticFood"}
                  />
                  <span>
        ...
        <div
          className={`${
            allSelected
              ? "item-card-for-item-showing-div-grid"
              : "Two-rows-item-card"
          }`}
        >
          {(() => {
            let matchingItemsExist = false;
            ...
            const items = data.map((item, id) => {
              if (
                ...
                if (
                  item.category === userFilteredCategory &&
                  item.price <= values[1] &&
                  item.price >= values[0]
                ) {
                  matchingItemsExist = true;
