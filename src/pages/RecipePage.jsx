...
const RecipePage = () => {
  ...
  console.log("Recipe in recipePage:", recipe);
  ...
  return (
    <div className="single-recipe">
      ...
      <div className="single-recipe-card">
        <div className="imageAndDetails">
          <div className="moreDetails">
            <h2>More Details</h2>
            <ul>
              <li>Total Calories: {roundedCalories}</li>

              <li>Caution: {recipe.recipe.cautions}</li>

              <li>Cuisine type: {recipe.recipe.cuisineType}</li>

              <li>Dish type: {recipe.recipe.dishType}</li>

              <li>Meal type: {recipe.recipe.mealType}</li>
          ...
          <div className="healthLabels">
            <p>
              {healthLabels.map((healthyTags) => {
                return <div className="health-tags-para">{healthyTags}</div>;
              })}
            </p>
          </div>
        </div>

        <h1 className="recipePage-heading">{recipe.recipe.label}</h1>

        <div className="ingredient-div">
          <p className="ingredient-needed">Ingredients needed:</p>
          <div className="ingredients">{recipe.recipe.ingredientLines}</div>
          <div className="summer-sale">
            <div className="summer-sale-Div">
              <div>
                <h3>Summer Sales</h3>
              ...
              <div className="discount-summersale">
                <p>up to</p>
                <p>56%</p>
                <p>Off</p>
              </div>
      ...
      <div className="comment-section">
        <div className="commenting-requirement">
          <p className="Leave-a-Comment">Leave a Comment</p>

          <div className="input-section-name-and-email">
          ...
          <div className="savemyname">
            ...
            <label htmlFor="savemyname">
              Save my name and email in this browser for the next time I
              comment.
            </label>
          </div>

          <button className="post-comment">Post Comments</button>
        </div>

        <div className="other-comments">
          <h2>Comments</h2>

          <div className="other-comment-pfp">
            <div className="commenter-pfp1"></div>

            <div className="comment-and-commentdatename">
              <div className="commenter-date-name">
                <h3>Annette Black</h3>
                <p className="dot">.</p>
                <p className="date">26 Apr, 2021</p>
              </div>
          ...
          <div className="other-comment-pfp">
            <div className="commenter-pfp2"></div>
            ...
            <div className="comment-and-commentdatename">
              ...
              <div className="the-comment">
                ...
                Nunc sit amet erat quis ex convallis suscipit. Nam hendrerit,
                velit ut aliquam euismod, nibh tortor rutrum nisi, ac sodales
                nunc eros porta nisi. Sed scelerisque, est eget aliquam
                venenatis, est sem tempor eros.
              </div>
            </div>
          </div>

          <div className="other-comment-pfp">
            <div className="commenter-pfp3"></div>
          ...
          <div className="other-comment-pfp">
            <div className="commenter-pfp4"></div>
          ...
          <div className="other-comment-pfp">
            <div className="commenter-pfp5"></div>
