              ...
              return (
                <div className="item" key={id}>
                  ...
                  <div className="items-name-eye">
                    ...
                    <FaEye className="eye" onClick={() => handleClick(item.id)}/>
                  </div>
